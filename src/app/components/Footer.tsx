...
export default function Footer(){
    return(
       ...
       <Link href="https://www.linkedin.com/in/syedshahmirsultan/">
       <BsFacebook size={24}  className='text-gray-300 hover:text-blue-600'/></Link>
       <Link href="https://github.com/syedshahmirsultan">
       <BsGithub size={24}  className='text-gray-300 hover:text-green-700'/></Link>
       <Link href="https://www.linkedin.com/in/syedshahmirsultan/">
       <BsLinkedin size={24}  className='text-gray-300 hover:text-blue-600'/>
       </Link>
        </div>
        <div>
        <Link href="https://github.com/syedshahmirsultan"><p className='text-gray-300 text-md font-semibold p-6 hover:text-white cursor-pointer'>© All rights reserved @syedshahmirsultan</p></Link>
        </div>
        </div></section>
    )
}