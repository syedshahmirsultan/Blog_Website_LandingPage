...
<div className='absolute hidden group-hover:inline-flex bottom-0 left-0 w-fullbg-opacity-20 bg-slate-900 backdrop-blur-3xl
rounded drop-shadow-lg text-white justify-center duration-200 p-5 w-full'>
